...
std::string resultFile = "results_final-draft_V2.csv";
...
int main() {
    ...
    std::string str;
    int prime;
    int primeLimit = 23; // max number to read in
    ...
    for (int n : primes) {
        ...
        for (int k = 4; k <= N/2 + 1; k ++) { // TODO int k = 2, changing to 4 for manual test
            if (goNext) {
                break;
            }
